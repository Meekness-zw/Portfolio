...
const about = {
  ...
  info: [
    ...
    { fieldName: "Languages", fieldValue: "English, Shona" },
...
const Resume = () => {
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 2.4, duration: 0.4, ease: "easeIn" } }} className="min-h-[80vh] flex items-center justify-center py-12 xl:py-10 font-primary">
          ...
          <div className="min-h-[70vh] w-full">
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, index) => {
                      return (
                        <li key={index} className="bg-[#232329] h-[194px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
            ...
            <TabsContent value="about" className="w-full text-center xl:text-left">
              <div>
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 max-w-[623px] mx-auto xl:mx-0">
